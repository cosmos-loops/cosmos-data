...
namespace Cosmos.Data
{
    public static class DbContextConfigExtensions
    {
        ...
        public static IDbContextConfig UseDapperWithPostgreSqlStrictly<TContext>(
            this IDbContextConfig config,
            string name,
            string connectionString,
            Action<FluentMapConfiguration> configureConvention = null,
        ...
        public static IDbContextConfig UseDapperWithPostgreSqlStrictly<TContext>(this IDbContextConfig config,
            string name,
            IConfiguration configuration,
            Action<FluentMapConfiguration> configureConvention = null,
            IList<Assembly> mappingAssemblies = null)
