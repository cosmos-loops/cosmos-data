...
namespace System.Data.SQLite
{
    ...
    public static partial class SQLiteExtensions
    {
        ...
        /// <returns>A T.</returns>
        public static T ExecuteEntity<T>(this SQLiteConnection @this, string cmdText, SQLiteParameter[] parameters, CommandType commandType, SQLiteTransaction transaction)
            where T : new()
        {
